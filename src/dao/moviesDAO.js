...
export default class MoviesDAO {
  ...
  static async getMoviesByCountry(countries) {
    ...
    */
    ...
    try {
      ...
      const projections = { projection: { title: 1 } }
      cursor = await (await movies.find(query, projections)).toArray()
    } catch (e) {
  ...
  static async getMovies({
    ...
    */
    ...
    const displayCursor = cursor.limit(moviesPerPage).skip(moviesPerPage * page).limit(moviesPerPage)
